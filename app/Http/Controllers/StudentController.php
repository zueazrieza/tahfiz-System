...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $student->load(['classRoom.primaryTeacher', 'teacher']);
        ...
        return response()->json([
            ...
            'teacherName'          => $student->teacher?->name ?? $student->classRoom?->primaryTeacher?->name ?? 'Belum Ditapis',
            'className'            => $student->classRoom?->name ?? 'Belum Ditapis',
        ]);
    }
