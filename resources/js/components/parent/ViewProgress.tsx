          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {earnedAchievements.map((a) => {
              const RANK_IMAGES: Record<string, string> = {
                'Tahsin':                    '/images/logo/warrior.jpeg',
                'Level 1':                   '/images/logo/warrior.jpeg',
                'Warrior':                   '/images/logo/warrior.jpeg',
                'Elite':                     '/images/logo/elite.jpeg',
                'Level 2':                   '/images/logo/elite.jpeg',
                'Master':                    '/images/logo/master.jpeg',
                'Level 3':                   '/images/logo/master.jpeg',
                'Grandmaster':               '/images/logo/grandmaster.jpeg',
                'Titan':                     '/images/logo/titan.jpeg',
                'Gladiator':                 '/images/logo/gladiator.jpeg',
                'Level 4':                   '/images/logo/gladiator.jpeg',
                'Legend Al-Hafiz':           '/images/logo/legend-al-hafiz.jpeg',
                'Legend Al-Hafiz Amethyst':  '/images/logo/amthyst.jpeg',
                'Legend Al-Hafiz Ruby':      '/images/logo/ruby.jpeg',
                'Legend Al-Hafiz Sapphire':  '/images/logo/sapphire.jpeg',
                'Emerald Syahadah':          '/images/logo/emerald-syahadah.jpeg',
                'Diamond Syahadah':          '/images/logo/diamond-syahadah.jpeg',
                'Syahadah Emperor':          '/images/logo/emerald-syahadah.jpeg',
              };
